...
public class UpdateProductPrice extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1380916104;

    /**
     * The parameter <code>public.update_product_price.pr_id</code>.
     */
    public static final Parameter<Integer> PR_ID = createParameter("pr_id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.update_product_price.sh_id</code>.
     */
    public static final Parameter<Integer> SH_ID = createParameter("sh_id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>public.update_product_price.amount</code>.
     */
    ...
    public UpdateProductPrice() {
        super("update_product_price", Public.PUBLIC);
