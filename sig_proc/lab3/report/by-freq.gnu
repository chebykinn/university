...
if (!exists("filename")) filename='img/by-freq.png'
if (!exists("datasrc"))  datasrc='by-freq.dat'
set style data lines
set xlabel "Частота основного сигнала"
set ylabel "SNR out"
...
set terminal dumb
set output '/dev/null'
plot for [IDX=0:2] datasrc i IDX u 1:2
