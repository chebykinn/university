...
\lstinputlisting{src/pwm.v}

\lstinputlisting{src/controller.v}

\section{Структурная схема RTL-модели}
\centering
\includegraphics[height=\textheight]{images/scheme.png}

\includegraphics[height=\textheight]{images/pwm.png}
...
\centering
\includegraphics[height=\textheight]{images/graph1.png}
\includegraphics[height=\textheight]{images/graph2.png}
