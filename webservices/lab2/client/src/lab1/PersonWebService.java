...
public interface PersonWebService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "uploadAvatar", targetNamespace = "http://lab1.webservices.chebykin.org/", className = "lab1.UploadAvatar")
    @ResponseWrapper(localName = "uploadAvatarResponse", targetNamespace = "http://lab1.webservices.chebykin.org/", className = "lab1.UploadAvatarResponse")
