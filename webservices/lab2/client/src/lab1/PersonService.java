 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://lab1.webservices.chebykin.org/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://lab1.webservices.chebykin.org/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://lab1.webservices.chebykin.org/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1.webservices.chebykin.org/", "PersonWebServicePort"), PersonWebService.class, features);
    }
