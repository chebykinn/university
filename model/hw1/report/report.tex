...
\multirow{4}{*}{Число заявок}       & П1     & $m_1 = p_8+p_9+p_{10}+p_{11}+p_{12}+p_{13}+p_{14}+p_{15}$                                                & 0,8333   \\ \cline{2-4}
                                    & П2     & $m_2 = p_4+p_5+p_6+p_7+p_8+p_9+p_{10}+p_{11}$                                                            & 0,3888   \\ \cline{2-4}
                                    & П3     & $m_3 = p_1 + 2p_2+3p_3 + p_5 + 2p_6 + 3p_7 + p9+ 2p_{10} + 3p_{11} + p_{13} + 2p_{14} + 3p_{15}$         & 0,7333   \\ \cline{2-4}
                                    & Сумма  & $m = m_1 + m_2 + m_3$                                                                                    & 1,9555   \\ \hline
\multirow{4}{*}{Время ожидания}     & П1     & $w_1=\frac{l_1}{\lambda'_1}$                                                                             & 0        \\ \cline{2-4}
                                    & П2     & $w_2=\frac{l_2}{\lambda'_2}$                                                                             & 0        \\ \cline{2-4}
                                    & П3     & $w_3=\frac{l_3}{\lambda'_3}$                                                                             & 5,7143   \\ \cline{2-4}
                                    & Сумма  & $w = \frac{\lambda'_1 w_1}{\lambda'} + \frac{\lambda'_2 w_2}{\lambda'}+ \frac{\lambda'_3 w_3}{\lambda'}$ & 1,2665   \\ \hline
\multirow{4}{*}{Время пребывания}   & П1     & $u_1 = \frac{m_1}{\lambda'_1}$                                                                           & 20,000   \\ \cline{2-4}
                                    & П2     & $u_2 = \frac{m_2}{\lambda'_2}$                                                                           & 3,1818   \\ \cline{2-4}
